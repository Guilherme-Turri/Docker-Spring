...
import com.apirestdocker.course.service.PersonService;
...
public class PersonController {
	...
	@Autowired // injectionDependecie by SrpingBoot
	private PersonService personService;
@CrossOrigin(origins = "http://localhost:8080") // acceess cors only local
	...
	@GetMapping(produces = { MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE }) // PRODUCES ONLY FOR
	...
	@CrossOrigin(origins = {"http://localhost:8080", "httsp://erudcio.com"})
	@PostMapping(value = "/v2", consumes = MediaType.APPLICATION_JSON_VALUE, produces = {
